# Downloaded from http://github.com/rails/rails/tree/1abdc8752d7fbc0733da763e751a2671db42961a%2Factionpack%2Flib%2Faction_view%2Fhelpers%2Fatom_feed_helper.rb?raw=true
# placed in the FCAtomFeedHelper module so as not to conflict with the existing one..

# Adds easy defaults to writing Atom feeds with the Builder template engine (this does not work on ERb or any other
# template languages).
module ActionView
  module Helpers #:nodoc:
    module FCAtomFeedHelper
      # Full usage example:
      #
      #   config/routes.rb:
      ...
      def fc_atom_feed(options = {}, &block)
